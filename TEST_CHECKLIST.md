...
- [ ] Create a dormitory and room; edit them; verify a room cannot be deleted while linked to a tenant.
...
- [ ] Move out a tenant; confirm the occupied-bed count drops and the bed can be reused.
...
- [ ] Log a visitor and check them out; confirm the date filter finds the record.
- [ ] Add and update a maintenance request; test every status and staff assignment.
- [ ] Add a calendar event and comment; import a small CSV with `employee_id,date`; re-import it and confirm duplicates are skipped.
